...
module.exports = {
    ...
    SESSION: process.env.ANU-SER_SESSION === undefined ? '' : process.env.ANU-SER_SESSION,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ ANSHID' : process.env.ALL_CAPTION,
    MENTION: process.env.TAG_REPLY === undefined ? '916238560752@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? '  ☚⃟፝༄HYDRA☚⃟፝࿐  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '✮⃝🎸HYDRA ÐØ₩₦ŁØÐł₦G ¥ØUƦ $Ø₦G✮⃝🎧' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '✮⃝🎸HYDRA UPŁØλÐł₦G ¥ØUƦ $Ø₦G✮⃝🎧' : process.env.SONGU,
    ...
    YAK: process.env.YAK === undefined ? '916238560742,0' : process.env.YAK,
    OWNERSHIP: process.env.OWNER_SHIP === undefined ? 'ANSHID' : process.env.OWNER_SHIP,
    LOGO: process.env.LOGO_LINK === undefined ? 'https://i.imgur.com/880CEdp.jpeg' : process.env.LOGO_LINK,
    BOTV2: process.env.BOTV2_NAME === undefined ? 'HYDRA' : process.env.BOTV2_NAME,
